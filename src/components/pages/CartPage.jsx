  ...
  return (
    <>
      {cartItems.length > 0 ? (
        ...
        <div className="h-screen max-w-6xl mx-auto flex flex-col items-center justify-center text-center space-y-6">
          <h2 className="text-4xl uppercase font-semibold font-poppins">
            Your cart is empty...
          </h2>
          <p className="text-xl font-roboto text-slate-600">
            Add items to continue shopping.
          </p>
          <Link
            to={'/'}
            className="bg-gradient-to-r from-teal-600 to-teal-900 font-poppins font-semibold shadow-lg rounded-lg px-6 py-4 text-zinc-100 transition hover:scale-105 hover:translate-x-1 hover:duration-300 ease-in uppercase"
          >
            Continue Shopping
          </Link>
        </div>
